...
sbg = {
	...
	'air' :  [
		// #1
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'S1,S2', 'valveName' : 'Y1'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1, LS2', 'valveName' : 'Y2, Y3'}
			],
			'relay' : 5,
			'sol' : 3,
			'fixList' : [
		...
		// #2
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1, LS2', 'valveName' : 'Y3'}
			],
			'relay' : 4,
			'sol' : 3,
			'fixList' : [
		...
		// #3
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1, LS2', 'valveName' : 'Y3, Y4'}
			],
			'relay' : 3,
			'sol' : 4,
			'fixList' : [
		...
		// #4
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'S1,S2', 'valveName' : 'Y1'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1, LS2', 'valveName' : 'Y2'}
			],
			'relay' : 5,
			'sol' : 2,
			'fixList' : [
		...
		// #12
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2', 'special' : '전진(A,B 반대로 결선)'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1, LS2', 'valveName' : 'Y3, Y4', 'special' : '전진(A,B 반대로 결선)'}
			],
			'relay' : 8,
			'sol' : 4,
			'fixList' : [
		...
		// #13
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1, LS2', 'valveName' : 'Y3', 'special' : '전진(A,B 반대로 결선)'}
			],
			'relay' : 5,
			'sol' : 4,
			'fixList' : [
	...
	'oil' : [
		// #1
		{
			...
			'sols' : [
				...
				{'name':'B', 'type':'Motor', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y2', 'special' : '3/2, 체크밸브'}
			],
			'relay' : 3,
			'sol' : 2,
			'fixList' : [
		...
		// #2
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1,LS2', 'valveName' : 'Y1, Y3'},
		...
		// #3
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1,LS2', 'valveName' : 'Y1'},
				{'name':'B', 'type':'Motor', 'solType' : 'double', 'sw' : 'x', 'special' : 'all-block', 'valveName' : 'Y2, Y3'}
			],
			'relay' : 2,
			'sol' : 3,
			'fixList' : [
		...
		// #5
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1,LS2', 'valveName' : 'Y1, Y2', 'special' : 'all-block'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS3, LS4', 'valveName' : 'Y3, Y4', 'special' : 'all-block'}
			],
			'relay' : 4,
			'sol' : 4,
			'fixList' : [
		...
		// #6
		{
			...
			'sols' : [
				{'name':'A', 'type':'Motor', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y1', 'special' : '2/2, 체크밸브'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1, LS2', 'valveName' : 'Y2, Y3', 'special' : '전진(CrossEleven-X11)'}
			],
			'relay' : 3,
			'sol' : 3,
			'fixList' : [
		...
		// #7
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS1, LS2', 'valveName' : 'Y1, Y2', 'special' : 'all-block'},
				{'name':'B', 'type':'Motor', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y3', 'special' : '체크밸브, A,B 반대로 결선'}
			],
			'relay' : 3,
			'sol' : 3,
			'fixList' : [
		...
		// #9
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1, LS2', 'valveName' : 'Y1'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'LS3, LS4', 'valveName' : 'Y2, Y3', 'special' : 'all-block'}
			],
			'relay' : 5,
			'sol' : 3,
			'fixList' : [
		...
		// #11
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2', 'special' : 'all-block'},
				{'name':'B', 'type':'Cylinder', 'solType' : 'single', 'sw' : 'LS1, LS2', 'valveName' : 'Y3', }
			],
			'relay' : 4,
			'sol' : 3,
		...
		// #12
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2', },
				{'name':'B', 'type':'Motor', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y3', },
				{'name':'-', 'type':'-', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y4', 'special' : '2/2'}
			],
			'relay' : 3,
			'sol' : 4,
			'fixList' : [
		...
		// #14
		{
			...
			'sols' : [
				{'name':'A', 'type':'Cylinder', 'solType' : 'double', 'sw' : 'S1,S2', 'valveName' : 'Y1, Y2', 'special':'all-block'},
				{'name':'B', 'type':'Motor', 'solType' : 'single', 'sw' : 'x', 'valveName' : 'Y3', 'special':'A,B반대로 결선,체크밸브'}
			],
			'relay' : 3,
			'sol' : 3,
			'fixList' : [
